...
class Main {
  ...
  initializeStyleTransfer() {
    // Initialize images
    this.contentImg = document.getElementById('paint-canvas');

    this.styleImg = new Image();
    this.styleImg.src = "img/style.jpg";

    this.stylized = document.getElementById('paint-canvas');
  ...
  async startStyling() {
    ...
    this.styleButton.textContent = '🖌️';
    await tf.nextFrame();
    ...
    var context = this.stylized.getContext("2d");
